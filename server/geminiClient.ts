...
Research separately: (1) official website/contact page; (2) direct merchant pages on Instagram, Facebook, TikTok/Douyin, Xiaohongshu, Weibo, YouTube, Yelp, TripAdvisor, Dianping/Meituan and delivery platforms; (3) official or credible menu pages with real dish names and prices; (4) merchant/dish image URLs only when the image itself and its containing source page are both available; (5) recognizable official visual identity cues such as brand colors, logo shape, mascot, packaging motifs, interior mood and typography style, clearly distinguishing sourced facts from visual design inference.
